...
VALUES
  ...
  ('echo.certforge.r5.status',
   ...
   '{"type":"object","required":["command","run_id"],"properties":{"command":{"type":"string","minLength":1,"maxLength":64},"run_id":{"type":"string","pattern":"^[A-Za-z0-9._-]{1,64}$"}},"additionalProperties":false}'::jsonb,
   'tier:1', 1, 30, 'active', 'unknown')
